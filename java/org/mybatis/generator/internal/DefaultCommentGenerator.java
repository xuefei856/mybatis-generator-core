...
//        compilationUnit.addFileCommentLine(" *  "+compilationUnit.getType().getFullyQualifiedName());
//        compilationUnit.addFileCommentLine("*/");
...
//        xmlElement.addElement(new TextElement("-->")); //$NON-NLS-1$
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        innerClass.addJavaDocLine(" * " + introspectedTable.getFullyQualifiedTable().getRemarks()); //$NON-NLS-1$
        innerClass.addJavaDocLine(" */"); //$NON-NLS-1$
    }
...
//        innerEnum.addJavaDocLine(" */"); //$NON-NLS-1$
    ...
    public void addFieldComment(Field field,
        ...
        field
                .addJavaDocLine(" * " + introspectedColumn.getRemarks());   //数据库字段注释

//        sb.append(" * "); //$NON-NLS-1$
//        sb.append(introspectedTable.getFullyQualifiedTable());  //数据库字段
